...
\begin{table}[htbp]
    ...
    pdf & $f(z)$ & $f_X(x) = f\left(\frac{x - \mu}{\sigma}\right)$ & $\frac{1}{b - a}$ for $a \le x \le b$ \\ 
...
- When we draw a sample of size $n$: $\{Y_1, \dots, Y_n\}$ from a population $P$, then the sampling distribution is the distribution of $\bar{Y} = \frac{1}{n}(Y_1 + \dots + Y_n)$.
